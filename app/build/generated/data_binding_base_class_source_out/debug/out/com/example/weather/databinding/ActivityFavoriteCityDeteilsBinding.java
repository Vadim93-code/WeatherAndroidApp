...
public final class ActivityFavoriteCityDeteilsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityFavoriteCityDeteilsBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull TextView pressure, @NonNull RecyclerView rcView, @NonNull TextView status,
      @NonNull TextView sunrise, @NonNull TextView sunset, @NonNull TextView temp,
      @NonNull TextView tempMax, @NonNull TextView tempMin, @NonNull TextView wind) {
  ...
  @NonNull
  public static ActivityFavoriteCityDeteilsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFavoriteCityDeteilsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_favorite_city_deteils, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFavoriteCityDeteilsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFavoriteCityDeteilsBinding((RelativeLayout) rootView, address,
          addressContainer, detailsContainer, errorText, humidity, loader, mainContainer,
